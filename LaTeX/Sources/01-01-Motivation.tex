...
A real-world application with great potential to benefit from this framework and its goals is the visualization of opinion networks \cite{betz2019applying} and in particular how they evolve over time.
