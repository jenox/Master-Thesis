...
% dynamic maps
% "this paper we consider visualizing large-scale dynamic relational data"
% "The problem becomes harder when we would also like to visualize some underlying process."

%\todo{De Berg \etal{} \cite{cartograms-rectilinear} "On Rectilinear Duals for Vertex-Weighted Plane Graphs"} -> dual
