...
Due to our choice of bend locations, the generated embedding is planar: We draw edges from the barycenter of all faces to the midpoints of their incident edges (in \crefrange{line:transformation-loop2-start}{line:transformation-loop2-end}); these edges cannot possibly cross. The remainder of the edges (in \crefrange{line:transformation-loop3-start}{line:transformation-loop3-end}) partition the boundary of the outer face of $G_\text{emb}$. Obviously, these two classes of edges do not cross and $G_\text{init}$ is therefore planar.
