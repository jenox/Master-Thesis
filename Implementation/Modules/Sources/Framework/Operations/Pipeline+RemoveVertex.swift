...
extension PolygonalDual {
    public struct RemoveFaceWithoutBoundaryToExternalFaceOperation: Equatable, Hashable {
        public init(name: ClusterName) {
            self.name = name
        }
    ...
    public func possibleRemoveFaceWithoutBoundaryToExternalFaceOperations() -> Set<RemoveFaceWithoutBoundaryToExternalFaceOperation> {
        return Set(self.embeddedClusterGraph.removableInternalVertices.map(RemoveFaceWithoutBoundaryToExternalFaceOperation.init))
    }

    public mutating func removeFaceWithoutBoundaryToExternalFace(_ operation: RemoveFaceWithoutBoundaryToExternalFaceOperation) throws {
        try self.removeFace(operation.name)
    }
}

extension PolygonalDual {
    public struct RemoveFaceWithBoundaryToExternalFaceOperation: Equatable, Hashable {
        public init(name: ClusterName) {
            self.name = name
        }
    ...
    public func possibleRemoveFaceWithBoundaryToExternalFaceOperations() -> Set<RemoveFaceWithBoundaryToExternalFaceOperation> {
        return Set(self.embeddedClusterGraph.removableExternalVertices.map(RemoveFaceWithBoundaryToExternalFaceOperation.init))
    }

    public mutating func removeFaceWithBoundaryToExternalFace(_ operation: RemoveFaceWithBoundaryToExternalFaceOperation) throws {
        try self.removeFace(operation.name)
    }
}

extension PolygonalDual {
    private mutating func removeFace(_ faceID: FaceID) throws {
...
extension MutablePolygonalDual {
    fileprivate func removeFace(_ faceID: FaceID) throws {
...
extension EmbeddedClusterGraph {
    ...
    fileprivate var removableInternalVertices: [Vertex] {
    ...
    fileprivate var removableExternalVertices: [Vertex] {
