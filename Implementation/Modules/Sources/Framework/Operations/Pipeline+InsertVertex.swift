...
extension PolygonalDual {
    public struct InsertFaceInsideOperation: Equatable, Hashable {
        public init(name: ClusterName, weight: ClusterWeight, incidentTo u: ClusterName, _ v: ClusterName, _ w: ClusterName) {
            self.name = name
            self.weight = weight
    ...
    public func possibleInsertFaceInsideOperations(name: ClusterName, weight: ClusterWeight) -> Set<InsertFaceInsideOperation> {
    ...
    public mutating func insertFaceInside(_ operation: InsertFaceInsideOperation) throws {
...
extension PolygonalDual {
    public struct InsertFaceOutsideOperation: Equatable, Hashable {
        public init(name: ClusterName, weight: ClusterWeight, incidentTo u: ClusterName, _ v: ClusterName) {
            self.name = name
            self.weight = weight
    ...
    public func possibleInsertFaceOutsideOperations(name: ClusterName, weight: ClusterWeight) -> Set<InsertFaceOutsideOperation> {
    ...
    public mutating func insertFaceOutside(_ operation: InsertFaceOutsideOperation) throws {
...
extension PolygonalDual {
    private mutating func insertFace(named name: ClusterName, weight: ClusterWeight, at vertex: Vertex) throws {
...
extension MutablePolygonalDual {
    fileprivate func insertFace(named name: ClusterName, weight: ClusterWeight, at vertex: Vertex) throws {
...
extension EmbeddedClusterGraph {
    ...
    fileprivate var insertionPositionsInside: [(Vertex, Vertex, Vertex)] {
    ...
    fileprivate var insertionPositionsOutside: [(Vertex, Vertex)] {
