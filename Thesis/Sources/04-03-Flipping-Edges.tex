...
\Cref{fig:flip-edge-contract-boundary-below} shows how we contract the first edge of the oriented upwards without introducing edge crossings.
...
On top of that, inserting an edge in the outer face is only possible if it preserves the internal triangulatedness of the cluster graph.
