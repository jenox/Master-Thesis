...
\begin{figure}[H]
	...
	\caption{Exemplary evolution of the generated map for an input graph with $n = 10$ at different points in time $t \in \{0,1,2,3\}$. From (a) to (b) the blue-cyan boundary is flipped, from (b) to (c) the red-green boundary is flipped, and eventually from (c) to (d) the smaller red region is removed.}
