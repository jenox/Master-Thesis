...
//        graph.insert("A", at: .init(x: 0, y: 100), weight: 10)
//        graph.insert("B", at: .init(x: -100, y: 0), weight: 10)
//        graph.insert("C", at: .init(x: 100, y: 0), weight: 10)
//        graph.insert("D", at: .init(x: 0, y: -100), weight: 10)
//        graph.insertEdge(between: "A", and: "B")
...
//        graph.insert("A", at: CGPoint(x: -40, y: -60), weight: 10)
//        graph.insert("B", at: CGPoint(x: 40, y: -60), weight: 10)
//        graph.insert("C", at: CGPoint(x: 0, y: 0), weight: 10)
//        graph.insert("D", at: CGPoint(x: -40, y: 60), weight: 10)
//        graph.insert("E", at: CGPoint(x: 40, y: 60), weight: 10)
//        graph.insertEdge(between: "A", and: "B")
//        graph.insertEdge(between: "A", and: "C")
//        graph.insertEdge(between: "B", and: "C")
//        graph.insertEdge(between: "C", and: "D")
//        graph.insertEdge(between: "C", and: "E")
//        graph.insertEdge(between: "D", and: "E")
